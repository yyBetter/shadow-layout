...
//    }
    ...
    private fun initAttributes(context: Context, attrs: AttributeSet?) {
        ...
        try {
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_cornerRadius, resources.getDimension(R.dimen.default_corner_radius))
            mShadowRadius = attr.getDimension(R.styleable.ShadowLayout_shadowRadius, resources.getDimension(R.dimen.default_shadow_radius))
            mDx = attr.getDimension(R.styleable.ShadowLayout_dx, 0f)
            mDy = attr.getDimension(R.styleable.ShadowLayout_dy, 0f)
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_shadowColor, resources.getColor(R.color.default_shadow_color))
        } finally {
            attr.recycle()
        }
    }
